...
void ft_run_test(int test_num, char *haystack, char *needle)
{
    char *res_original = ft_strstr(haystack, needle);
    char *res_result = ft_strstr(haystack, needle);
