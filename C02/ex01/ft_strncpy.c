...
int main(void)
{
    printf("Iniciando pruebas para ft_strncpy...\n");
    ...
    ft_strncpy(dest1, "Hola", 7);
    assert(ft_strcmp(dest1, "Hola") == 0);
    ...
    ft_strncpy(dest2, "MundoLargo", 5);
    assert(ft_strncmp(dest2, "Mundo", 5) == 0);
    ...
    ft_strncpy(dest3, "Nuevo", 0);
    assert(ft_strcmp(dest3, "Original") == 0);
    ...
    // ft_strncpy debe retornar exactamente el puntero de destino original
    char dest5[10];
    char *ptr_retorno = ft_strncpy(dest5, "Test", 4);
