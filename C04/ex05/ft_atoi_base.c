...
int	ft_atoi_base(char *str, char *base)
{
	...
	result = 0;
	signo = 1;
	length_base = ft_check_base(base);
	if (length_base == 0)
		return (0);
...
int main(void)
{
	...
	//Octal
	printf("%d\n", ft_atoi_base("7", "01234567"));      // 7
	printf("%d\n", ft_atoi_base("10", "01234567"));     // 8
	printf("%d\n", ft_atoi_base("17", "01234567"));     // 15
	printf("%d\n", ft_atoi_base("777", "01234567"));    // 511

	//Hexadecimal
	printf("%d\n", ft_atoi_base("A", "0123456789ABCDEF"));      // 10
	printf("%d\n", ft_atoi_base("F", "0123456789ABCDEF"));      // 15
	printf("%d\n", ft_atoi_base("10", "0123456789ABCDEF"));     // 16
	printf("%d\n", ft_atoi_base("FF", "0123456789ABCDEF"));     // 255
	printf("%d\n", ft_atoi_base("ff", "0123456789abcdef"));     //255

	//Bases arbitrarias
	printf("%d\n", ft_atoi_base("a", "abc"));       //0
	printf("%d\n", ft_atoi_base("b", "abc"));       //1
	printf("%d\n", ft_atoi_base("c", "abc"));       //2
	printf("%d\n", ft_atoi_base("ba", "abc"));      //3
	printf("%d\n", ft_atoi_base("bc", "abc"));      //5

	//Poneyvif
	printf("%d\n", ft_atoi_base("p", "poneyvif"));      //0
	printf("%d\n", ft_atoi_base("o", "poneyvif"));      //1
	printf("%d\n", ft_atoi_base("n", "poneyvif"));      //2
	printf("%d\n", ft_atoi_base("e", "poneyvif"));      //3
	printf("%d\n", ft_atoi_base("y", "poneyvif"));      //4
	printf("%d\n", ft_atoi_base("po", "poneyvif"));     //1
	printf("%d\n", ft_atoi_base("ne", "poneyvif"));     //19

	//Bases invalidas
	printf("%d\n", ft_atoi_base("42", ""));             //0
	printf("%d\n", ft_atoi_base("42", "0"));            //0
	printf("%d\n", ft_atoi_base("42", "001"));          //0
	printf("%d\n", ft_atoi_base("42", "01+2"));         //0
	printf("%d\n", ft_atoi_base("42", "01-2"));         //0

	printf("%d\n",ft_atoi_base("12x34", "0123456789"));
	printf("%d\n",ft_atoi_base("101201", "01"));
	printf("%d\n",ft_atoi_base("ABZG", "ABCDEFGHIJKLMNOPQRSTUVWXYZ"));
	ft_atoi_base("0", "01");              // 0
	printf("%d\n", ft_atoi_base("000101", "01"));         // 5
	printf("%d\n", ft_atoi_base("12abc", "0123456789"));  // 12
